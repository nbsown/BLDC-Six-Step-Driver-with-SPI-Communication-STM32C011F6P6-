...
#define AH_PWM_Pin GPIO_PIN_0
#define AH_PWM_GPIO_Port GPIOA
#define BH_PWM_Pin GPIO_PIN_1
#define BH_PWM_GPIO_Port GPIOA
#define CH_PWM_Pin GPIO_PIN_2
#define CH_PWM_GPIO_Port GPIOA
